...
{
	protected static final String ROOT = Environment.getExternalStorageDirectory() + "/Android/data/uniquesudio.QuicK";
	...
	synchronized void updatefiles(final String dirPath)
	{
